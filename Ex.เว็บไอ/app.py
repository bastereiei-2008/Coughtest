...
# --- 4. Sidebar ---
with st.sidebar:
    st.image("""C:\Users\Lenovo\Ex.เว็บไอ\logowebtest.jpg""", width=60)
...
if st.session_state.page == 1:
    ...
    st.title("ระบบคัดกรองโรคทางเดินหายใจในเด็กเบื้องต้น")
    st.markdown("### CoughCareKids")
    st.write("---")
    c1, c2 = st.columns([1, 1])
    with c1:
        st.info("👋 **สวัสดีครับ** ระบบนี้จะช่วยประเมินความน่าจะเป็นของการเกิดโรคเเบื้องต้นจากเสียงไอและอาการร่วมของคุณ ด้วยเทคโนโลยี AI")
        st.markdown("""
        ...
        * 🫁 **Pneumonia** (โรคปอดบวม)
        """)
    with c2:
        st.warning("**⚠️ คำเตือน (Disclaimer)**\n\nผลลัพธ์จากระบบนี้เป็นเพียงการวิเคราะห์เบื้องต้นไม่สามารถใช้แทนคำวินิจฉัยของแพทย์ได้")
        st.write("")
